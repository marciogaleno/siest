    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <fieldset>
                        <legend>Instituiçao</legend>
                        <label>Nome:&nbsp;</label><?= $instituicao['nome'] ?><br>
                        <label>Representante:&nbsp;</label><?= $instituicao['representante'] ?><br>
                        <label>CNPJ:&nbsp;</label><?= $instituicao['cnpj'] ?><br>
                        <label>Endereço:&nbsp;</label><?= $instituicao['endereco'] ?><br>
                        <label>E-mail:&nbsp;</label><?= $instituicao['email'] ?><br>
                        <label>Telefone:&nbsp;</label><?= $instituicao['telefone'] ?><br>
                    </fieldset>
...
<script type="text/javascript">
    $(function () {
        var dialog, form,
                ...
                horario = $("#horario"),
                resumo = $("#resumo"),
                estagio_id = <?php echo "'" . $instituicao['id_estagio'] . "'" ?>,
