        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <fieldset>
                        <legend>Aluno</legend>
                        <label>Nome:&nbsp;</label><?= $aluno['nome'] ?><br>
                        <label>Matrícula:&nbsp;</label><?= $aluno['matricula'] ?><br>
                        <label>Telefone:&nbsp;</label><?= $aluno['telefone'] ?><br>
                        <label>Curso:&nbsp;</label><?= $aluno['nome_curso'] ?><br>
                    </fieldset>
...
<script type="text/javascript">
    $(function () {
        var dialog, form,
                ...
                horario = $("#horario"),
                resumo = $("#resumo"),
                estagio_id = <?php echo "'" . $aluno['id_estagio'] . "'" ?>,
