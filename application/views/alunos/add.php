                                ...
                                <form role="form" action="add" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="matricula" class="form-control" id="exampleInputEmail1" placeholder="Nome">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rg" class="form-control" id="exampleInputEmail1" placeholder="RG">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Data nascimento</label>
                                            <input type="text" name="dat_nasc" class="form-control" id="exampleInputEmail1" placeholder="Data nascimento">
                                        </div>
