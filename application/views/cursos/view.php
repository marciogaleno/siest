            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <fieldset>
                        ...
                        <label>Nome:&nbsp;</label><?= $curso['nome'] ?><br>
                        <label>Coordenador:&nbsp;</label><?= $curso['nome_professor'] ?><br>
                        <label>Categoria:&nbsp;</label><?=$curso['categoria'] ?><br>
                    </fieldset>
...
<script type="text/javascript">
    $(function () {
        var dialog, form,
                ...
                horario = $("#horario"),
                resumo = $("#resumo"),
                estagio_id = <?php echo "'" . $curso['id_estagio'] . "'" ?>,
