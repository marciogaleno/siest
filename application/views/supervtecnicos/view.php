    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <fieldset>
                        <legend>Supervisor Técnico</legend>
                        <label>Nome:&nbsp;</label><?=$superv_tecnico['nome'] ?><br>
                        <label>Representante:&nbsp;</label><?= $superv_tecnico['telefone'] ?><br>
                        <label>Instituição:&nbsp;</label><?= $superv_tecnico['nome_instituicao'] ?><br>
                    </fieldset>
...
<script type="text/javascript">
    $(function () {
        var dialog, form,
                ...
                horario = $("#horario"),
                resumo = $("#resumo"),
                estagio_id = <?php echo "'" . $superv_tecnico['id_estagio'] . "'" ?>,
